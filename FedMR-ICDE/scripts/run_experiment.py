...
from fedmr_kdd2026.config import ExperimentConfig, LLMConfig
from fedmr_kdd2026.experiment import run_experiment


def parse_args():
    parser = argparse.ArgumentParser(description="Run FedMR KDD2026 9-scenario experiment.")
    ...
    parser.add_argument("--num-eval-samples", default=20, type=int)
    ...
    parser.add_argument("--base-url", default="http://219.222.20.79:30834/v1")
